<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "nib_site_title" , "nib_site_description" , "nib_keyword" , "nib_keyword_description"   ,"{$Entity}IsActive" ),
		$ColumnTitle=array( "Site Title", "Site slogan" , "Key word" , "Key description"   ,"IsActive" ),
		$ColumnAlign=array( "left", "left" , "left" , "left"   , "left" ),
		$ColumnType=array( "text", "text" , "text" , "text"   ,"yes/no"),
